...
import wind_icon from '../images/wind1.png'
...
function Weather() {
  ...
  const search = async (city)=>{
    ...
    catch (error)
    {
      ...
      console.error("Error in feaching weather data");
    }
  }
    ...
    <div className='weather'>
      ...
      {weatherData?<>
        ...
        <div className="weather-data">
          <div className="col">
            <img src={humidity_icon} alt="" className='image1'/>
            <div>
          ...
          <div className="col">
            <img src={wind_icon} alt="" className='image2'/>
            <div>
